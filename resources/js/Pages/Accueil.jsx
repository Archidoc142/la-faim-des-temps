...
export default function Accueil() {
    ...
    return (
        <>
            ...
            <div className='h-[37rem] lg:h-[42rem] bg-[url("img/accueil.jpg")] bg-cover relative'>
                <div className='bg-white py-16 bg-opacity-75 my-auto absolute top-24 w-full lg:py-10'>
                    ...
                    <div className='flex justify-center'>
                        <Link href="/menu">
                            <button className='mt-8 lg:mt-4 uppercase bg-[#7A163C] text-white font-bold text-lg lg:text-base px-8 py-2 rounded-sm shadow-md hover:shadow-lg'>Menu de la semaine</button>
                        </Link>
                    </div>
                </div>
            </div>
