                ...
                <div className="fixed top-0 left-0 w-full h-screen z-40">
                    <div className="absolute w-full flex justify-center top-[50%] translate-y-[-50%] left-0 p-4">
                        ...
                        <div className="bg-white w-[850px] rounded-md p-6 z-40">
                            ...
                            <img className="h-56 mb-2 m-auto" src={imgSrc} alt={image ? image.alt : "image vide"} />
                            ...
                            <div className={(image ? "justify-between " : "justify-end ") + "flex flex-nowrap align-middle w-full"}>
                                {image ?
                                    <button type="button" onClick={() => deleteImage(image.id)} className="bg-red-700 text-white font-bold py-1.5 px-3 w-48 rounded hover:bg-slate-700 cursor-pointer">Supprimer</button>
                                    : null
                                }
                                <button type="submit" className="bg-[#06306D] text-white font-bold py-1.5 px-3 w-48 rounded hover:bg-slate-700 cursor-pointer">Enregistrer</button>
                            </div>
                        </div>
                    </div>
                </div>
