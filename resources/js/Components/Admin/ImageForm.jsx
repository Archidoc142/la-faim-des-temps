                    ...
                    <div className="absolute w-full flex justify-center top-[50%] translate-y-[-50%] left-0 p-4">
                        ...
                        <div className="bg-white w-[850px] rounded-md p-6 z-40">
                            <div className="flex flex-nowrap justify-between align-middle w-full mb-10">
                                <h2 className="text-2xl font-bold">{image ? "Modifier une image" : "Ajouter une nouvelle image"}</h2>
                            ...
                            <img className="h-48 mb-2 m-auto" src={imgSrc} alt={image ? image.alt : "image vide"} />
                            <p className="italic text-sm text-center mb-4">{filename}</p>
