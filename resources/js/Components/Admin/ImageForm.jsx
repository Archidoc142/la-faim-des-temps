                ...
                <div className="absolute w-full flex justify-center top-[15%] left-0 p-4">
                    <div className="bg-white w-[850px] rounded-md p-6 z-40">
                        ...
                        <div className="bg-[#7A163C] py-2 px-3 flex flex-nowrap w-fit rounded hover:bg-slate-700 cursor-pointer m-auto mb-6 relative">
                            ...
                            <input type="file" name="file" id="file" className="opacity-0 absolute top-0 left-0 w-full h-full hover:cursor-pointer" onChange={upload} accept="image/*"/>
                        </div>
                        ...
                        <div className={(image ? "justify-between " : "justify-end ") + "flex flex-nowrap align-middle w-full"}>
                            ...
                            <button type="submit" className="bg-[#06306D] text-white text-lg font-bold py-1 px-3 w-48 rounded hover:bg-slate-700 cursor-pointer">Enregistrer</button>
                        </div>
                    </div>
                </div>
            </div>
