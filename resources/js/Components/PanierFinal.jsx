    ...
    return (
        <>
            <div className="relative text-center">
                ...
                <h2 className="font-bold text-3xl py-6">Passer une commande</h2>


                <p className="font-bold text-lg pb-4 mx-10 mb-6 border-b-black border-b-[1px]">Finaliser la commande...</p>

                <h3 className="font-bold text-3xl mb-4">Sous-total:</h3>
                ...
                <h3 className="font-bold text-3xl mb-2">Adresse:</h3>
                <p>{adresse.nom}</p>

                <div className="text-left px-8 mt-2 mb-4">
                    <h4 className="font-bold mb-2">Ajouter vos allergènes</h4>
                    <textarea
                        id="allergene"
                        maxLength="128"
                        placeholder="Oeuf, Lait, Arachide, Soja..."
