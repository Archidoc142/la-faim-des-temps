...
export default function MessageFlash({ status, message, visibility, duration = 3, setVisibility }) {
    ...
    return (
        <div className="fixed right-10 bottom-10">
            {visible ?
            <div className={`flex gap-4 items-center p-4 rounded-[25px] text-center text-white bg-gradient-to-r from-[#15181c] to-[#0d1c3d] text-xl font-bold  border-2 top-[8%] py-6
             ${status === 1 ? "border-[#21543f]" :
                    ...
                    {status === 1 ?
                     ...
                     status === 2 ?
                        <svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="#a38322" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
