...
export default function PanierFinalisation({prix, setBoxVisible, adresses}) {
    ...
    const [adresse, setAdresse] = useState({id: 0, nom: "", montant: 0, code_postal: ""})
    ...
    return (
        <div id="finalisation">
            ...
            <div className="absolute w-full flex justify-center top-[12%] left-0 p-4">
                <div className={"bg-white w-[450px] sm:w-[500px] p-4 px-6 rounded-lg border-black border-2 " + (contentBox === 2 ? "h-[600px] !w-[420px] !px-4 " : "") + (contentBox === 1 ? "!w-[500px] " : "") + (contentBox && adresse.id === 0 ? "!h-[540px]" : "")}>
                    {/* Content*/}
